        ...
        >
          ...
          <div className="relative flex items-start justify-between">
            <div>
              ...
              <p className="mt-3 text-3xl font-semibold">{format(totals[key])}</p>
            </div>
            <span className="flex h-11 w-11 items-center justify-center rounded-xl border border-border bg-muted/60 dark:border-white/10 dark:bg-[#1c2230]">
